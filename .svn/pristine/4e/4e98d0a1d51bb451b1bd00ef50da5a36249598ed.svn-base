export default {
  route: {
    ...
    'gatherInfo':'info Manager',
    'client_info':'Customer Information',
    'client_detail_info':'Customer Detail Information'
  },
  navbar: {
    'dashboard': 'Dashboard',
    'github': 'Github',
  ...
  sysmenu: {
    ...
    'dataTitle': 'Data Permissions, click table cell edit',
  ...
  customer:{
    ...
    'clientAccount':'customer broadband number', 
    'clientCity':'City Name',
    'clientCounty':'name of district and county',
    'clientTownship':'Street Town',
    'clientHamlet':'Community Village',
    'clientAddress':'Customer Address',
    installedDate:'Installation Time',
    enabled:'Customer Status',
    'clientName-required':'Please enter the client name',
    'clientAccount-required':'Please enter the broadband number',
    'childrenStatus':'Status of children',
    ...
    industry: "industry",
    post: "position", 
    unitaddres: "company address",
    detailedaddres: "detailed address,",
    unitcontact: "unit contact",
    unitphone: "contact number of unit",
