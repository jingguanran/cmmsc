...
import personaloaRouter from './modules/personaloa'
import nestedRouter from './modules/nested'
import gatherInfoRouter from './modules/gather_info'
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          ...
          // if do not set roles, means: this page does not require p ermission
        }
      },
      {
        path: 'role',
